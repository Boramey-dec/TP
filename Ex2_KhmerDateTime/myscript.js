(function() {
    ...
    2: [function(require, module, exports) {
            ...
            //document.getElementById('btnShow').onclick = translateKhmer;

            function translateKhmer() {
            ...
            function onShow() {
                ...
                var getDate1 = document.getElementById("dataInputdate1").value;
                var getDate2 = document.getElementById("dataInputdate2").value;
                var getDate = getDate1.concat(" " + getDate2);
